...
\begin{itemize}
    ...
    \item Se realizó una cuarta medida en la misma posición que la tercera pero empleando una polarización vertical y por lo tanto se observa más atenuación que en la medida anterior
