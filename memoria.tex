...
La constnate de fase $\beta$ tiene como pendiente el tiempo de propagación. Está modelada por la ecuación \ref{eq:constante_fase_coaxial} . En la figura \ref{fig:constante_fase.pdf}. Normalizando este para que sean comparables9
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=\columnwidth]{figuras/constante_fase.pdf}
    \caption{Atenuación por unidad de longitud en función de la frecuencia en un cable coaxial Belden}
    \label{fig:constante_fase}
\end{figure}
\begin{figure}[htb]
    \centering
    \includegraphics[width=\columnwidth]{figuras/respuesta_impulso.pdf}
